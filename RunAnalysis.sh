...
PPMOD_DIR=/home/antoniosilva/Dropbox/2357154.apollo-acf/2359154
rm *.so
...
rivet --pwd -p Rivet_pp.yoda -a Jet_Raa_Analysis:coll=PPMOD -o Rivet_PbPb.yoda --ignore-beams $PPMOD_DIR/jewel.hepmc
